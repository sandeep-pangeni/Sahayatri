<?php
$new_bookings = $obj->Query("SELECT * from bookings where status =  '2' ORDER BY time desc");

$cancelled_bookings_with_d = $obj->Query("SELECT * from bookings where driver!='0' and status =  '2' ORDER BY time desc");

$cancelled_bookings_without = $obj->Query("SELECT * from bookings where  driver='0' and status =  '2' ORDER BY time desc");
